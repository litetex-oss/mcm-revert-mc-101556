...
## Releasing [![Build](https://img.shields.io/github/actions/workflow/status/litetex-oss/mcm-revert-mc-101556/release.yml?branch=master)](https://github.com/litetex-oss/mcm-revert-mc-101556/actions/workflows/release.yml)

Before releasing:
* Consider doing a [test-deployment](https://github.com/litetex-oss/mcm-revert-mc-101556/actions/workflows/test-deploy.yml?query=branch%3Adev) before actually releasing.
